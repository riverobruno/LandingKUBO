  ...
  return (
    <main>
      ...
      >
        ...
        />
        <div
          className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(13,9,6,0.72)_0%,rgba(20,13,8,0.43)_33%,rgba(22,15,10,0.08)_70%),linear-gradient(180deg,rgba(13,9,6,0.45)_0%,transparent_31%,rgba(10,7,5,0.15)_100%)]"
          aria-hidden="true"
        />
